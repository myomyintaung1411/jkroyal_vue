  ...
  <div class="w-full h-screen relative">
    <div class="flex  h-screen w-full ">
      <div class="max-w-sm w-60  bg-slate-800 h-screen drawer_bg relative overflow-y-hidden ">
        ...
        <div class="py-2 w-full" v-for="n in 6" :key="n">
        <div class=" cursor-pointer">
          <div class="w-full py-3 px-3 rounded bg-slate-50 text-black hover:text-white hover:bg-slate-500 text-center shadow-xl ease-in duration-300 hover:rounded-tl-3xl hover:rounded-bl-3xl cursor-pointer">
            <p class="text-2xl tracking-wide font-medium">Hello</p>
          </div>
        </div>
        </div>
      ...
      <div class="main-content w-[calc(100%_-_15rem)]  h-screen relative overflow-y-hidden p-5  ">
        <div class="w-full  flex flex-wrap ">
          <div  v-for="n in 4" :key="n" @click="showModal()" class=" w-[500px] max-w-[500px] min-w-[500px]   flex overflow-hidden     bg-slate-800 h-52  shadow-lg m-5 shadow__  cursor-pointer ">
...
onMounted(()=>{
 ...
 const bindImage = (c) => {
  let image = ref(('./assets/static/img/dl-'+c+'.png'))
...
.shadow__{
  box-shadow: -3.828px -3.828px 6px 0px rgba(219, 169, 17, 0.4), 3px 5px 8px 0px rgb(255 82 1 / 20%);
}
.scroll_main{
